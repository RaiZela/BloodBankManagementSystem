...
namespace DAL.Migrations
{
    ...
    [Migration("20240925221723_IsDeeleted_Optional")]
    partial class IsDeeleted_Optional
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BloodBankManagementSystem.DAL.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "7884d5f0-114a-4d6b-877e-30c92f27a439",
                            Email = "admin@gmail.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedUserName = "RAIZELA@GMAIL.COM",
                            PasswordHash = "AQAAAAIAAYagAAAAEJ5uPJxBGDyHYvXDHq0E7EF3QugpVpcPF1mpgMz354mv+XKUdjo+o5l2PwqT3kHrQA==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "aaffefef-db76-43b5-baa0-4bf497dc62f5",
                            Status = 0,
            ...
            modelBuilder.Entity("DAL.Data.DatabaseModels.DeletedDonors", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DAL.Data.DatabaseModels.Donation", b =>
                {
                    ...
                    b.Property<int?>("DeletedDonorsID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DAL.Data.DatabaseModels.Donation", b =>
                {
                    ...
                    b.HasOne("DAL.Data.DatabaseModels.DeletedDonors", null)
                        .WithMany("Donations")
                        .HasForeignKey("DeletedDonorsID");
